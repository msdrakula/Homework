...
best_lecturer_1 = Lecturer('Дмитрий', 'Песков')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Угор', 'Крид')
best_lecturer_2.courses_attached += ['Java']

best_lecturer_3 = Lecturer('Стас', 'Михайлов')
best_lecturer_3.courses_attached += ['Python']

best_lecturer_4 = Lecturer('Алексей', 'Щербаков')
best_lecturer_4.courses_attached += ['JavaScript']

# Создаем проверяющих и закрепляем их за курсом
cool_reviewer_1 = Reviewer('Дима', 'Билан')
cool_reviewer_1.courses_attached += ['Python']
cool_reviewer_1.courses_attached += ['Java']

cool_reviewer_2 = Reviewer('Ольга', 'Бузова')
cool_reviewer_2.courses_attached += ['Python']
cool_reviewer_2.courses_attached += ['Java']

cool_reviewer_3 = Reviewer('Клава', 'Кока')
cool_reviewer_3.courses_attached += ['Python']
cool_reviewer_3.courses_attached += ['JavaScript']

# Создаем студентов и определяем для них изучаемые и завершенные курсы
student_1 = Student('Владимир', 'Слоловьев')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Стас', 'Пьеха')
student_2.courses_in_progress += ['Java']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Иван', 'Ургант')
student_3.courses_in_progress += ['Python']
student_3.finished_courses += ['Введение в программирование']

student_4 = Student('Андрей', 'Малахов')
student_4.courses_in_progress += ['JavaScript']
student_4.finished_courses += ['Введение в программирование']
...
student_4.rate_hw(best_lecturer_4, 'JavaScript', 8)
student_4.rate_hw(best_lecturer_4, 'JavaScript', 7)
student_4.rate_hw(best_lecturer_4, 'JavaScript', 10)
...
cool_reviewer_3.rate_hw(student_4, 'JavaScript', 8)
cool_reviewer_3.rate_hw(student_4, 'JavaScript', 7)
cool_reviewer_3.rate_hw(student_4, 'JavaScript', 9)
...
lecturer_list = [best_lecturer_1, best_lecturer_2, best_lecturer_3,best_lecturer_4]
